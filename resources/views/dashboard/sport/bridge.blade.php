...
<div class="card dashboard-card">
    <h4 class="card-title">เพิ่มกีฬาบริดจ์ <small><a href="{{route('event.index.dashboard')}}">กลับ</a></small></h4>
    <div class="card-block">
        ...
        <form action="{{route('event.store')}}" method="POST" >
            ...
            <div class="form-group">
                ...
                <small class="form-text text-muted">เช่น "มินิบริดจ์รอบที่ 1 โต๊ะที่ 1"</small>
            </div>
            ...
            <input type="hidden" name="label" value="bridge">
