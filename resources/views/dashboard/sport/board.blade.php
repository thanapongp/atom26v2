...
<div class="card dashboard-card">
    <h4 class="card-title">เพิ่มกีฬาหมากกระดาน <small><a href="{{route('event.index.dashboard')}}">กลับ</a></small></h4>
    <div class="card-block">
        ...
        <form action="{{route('event.store')}}" method="POST" >
            ...
            <div class="form-group">
                ...
                <small class="form-text text-muted">เช่น "หมากรุกไทยรอบที่ 1 โต๊ะที่ 1"</small>
            </div>
            ...
            <div class="form-group" style="width: 50%;">
                ...
                <input name="venue" type="text" value="สำนักคอมพิวเตอร์ฯ" class="form-control" readonly>
            </div>

            <input type="hidden" name="sport_id" value="7">
            <input type="hidden" name="label" value="board">
