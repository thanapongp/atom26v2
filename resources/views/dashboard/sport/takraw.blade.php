...
<div class="card dashboard-card">
    <h4 class="card-title">เพิ่มกีฬาตะกร้อ <small><a href="{{route('event.index.dashboard')}}">กลับ</a></small></h4>
    <div class="card-block">
        ...
        <form action="{{route('event.store')}}" method="POST" >
            ...
            <div class="form-group">
                ...
                <small class="form-text text-muted">เช่น "วอลเลย์บอลหญิงสาย A รอบแรก คู่ที่1"</small>
            </div>
            ...
            <div class="form-group" style="width: 50%;">
                ...
                <input name="venue" type="text" value="สนามตะกร้อกลางแจ้ง ลานบึกบึน" class="form-control" readonly>
            </div>

            <input type="hidden" name="sport_id" value="11">
            <input type="hidden" name="label" value="takraw">
            ...
            <table class="table w-100">
                ...
                <tbody>
                    ...
                    <td>
                        <input type="radio" name="is_winner" value="{{$i}}">
                    </td>
                    </tr>
                    @endfor
                </tbody>
