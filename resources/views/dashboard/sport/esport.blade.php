...
<div class="card dashboard-card">
    <h4 class="card-title">เพิ่มกีฬา E-Sport <small><a href="{{route('event.index.dashboard')}}">กลับ</a></small></h4>
    <div class="card-block">
        ...
        <form action="{{route('event.store')}}" method="POST" >
            ...
            <div class="form-group">
                ...
                <small class="form-text text-muted">เช่น "E-Sport (HON) กลุ่ม A รอบที่ 1 คู่ที่ 1"</small>
            </div>
            ...
            <div class="form-group" style="width: 50%;">
                ...
                <input name="venue" type="text" value="อาคารวิจัย คณะวิทย์ฯ" class="form-control" readonly>
            </div>

            <input type="hidden" name="sport_id" value="9">
            <input type="hidden" name="label" value="esport">
