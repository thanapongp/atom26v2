...
<div class="card dashboard-card">
    <h4 class="card-title">เพิ่มกีฬาวอลเลย์บอล <small><a href="{{route('event.index.dashboard')}}">กลับ</a></small></h4>
    <div class="card-block">
        ...
        <form action="{{route('event.store')}}" method="POST" >
            ...
            <div class="form-group" style="width: 50%;">
                ...
                <input name="venue" type="text" value="โรงพละ ม.อุบลฯ" class="form-control" readonly>
            </div>

            <input type="hidden" name="sport_id" value="4">
            <input type="hidden" name="label" value="volleyball">
